...
from MovieDataset import MovielensDataset
from encoder import CatGCNEncoder, SumGCNEncoder
from decoder import Decoder
from fully_connect import FullyConnected
...
class GraphMatrixCompletion(nn.Module):
    def __init__(self, input_dim, side_feat_dim,
        ...
        self.encoder = CatGCNEncoder(input_dim, gcn_hidden_dim, num_support, DROPOUT_RATIO)
...
def expected_rmse(logits, label):
    true_y = label + 1  # 评分为1~5，label为0~4
